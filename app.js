...
app.post('/sendmail/:id', function(req,res){
  ...
  var mailOptions = {
    ...
    text: 'This message has been automatically generated by the San Francisco Police Department.  Brent Amiano of San Francisco, CA has been arrested on suspicion of Drunk in Public under Penal Code 647(f)PC. He/She has requested that you post his bond at the San Francisco County Jail located at 425 7th St.', // plaintext body
